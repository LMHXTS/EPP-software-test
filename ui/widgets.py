...
class ArcGauge(tk.Canvas):
    ...
    def _draw(self):
        ...
        # 中心数值文字
        self.create_text(cx, cy - 18, text=f"{self.value:.1f}",
                          font=(T.FONT, 30, "bold"), fill=T.CHARCOAL)
        self.create_text(cx, cy + 16, text="度",
                          font=(T.FONT, 12), fill=T.WARMGRY)
...
class StatusPill(tk.Canvas):
    ...
    def _draw(self):
        ...
        self.create_text(self.w / 2, self.h / 2, text=self.text,
                          font=(T.FONT, 18, "bold"), fill=T.WHITE)
